...
"C:\Program Files\OpenSCAD\openscad.com" -o Cover-28mm.stl -D depth=28;showCover=true;showBase=false;showPcb=false;showSwitch=false JediLightSwitch.scad
...
"C:\Program Files\OpenSCAD\openscad.com" -o Cover-25mm.stl -D depth=25;showCover=true;showBase=false;showPcb=false;showSwitch=false JediLightSwitch.scad
...
"C:\Program Files\OpenSCAD\openscad.com" -o Cover-19mm.stl -D depth=19;showCover=true;showBase=false;showPcb=false;showSwitch=false JediLightSwitch.scad
...
"C:\Program Files\OpenSCAD\openscad.com" -o Cover-16mm.stl -D depth=16;showCover=true;showBase=false;showPcb=false;showSwitch=false JediLightSwitch.scad
